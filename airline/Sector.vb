...
Public Class Sector
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
        ...
        con.Open()
        Dim cxd As String = "select weekdays from Flights,Sector where Sector.SectorID=Flights.SectorID and weekday= '" & WeekDays.Text & "'"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "SectorID"))
        ...
        Else
            ...
            Dim cf As String = "Data Source=(localdb)\MSSQLLocalDB;AttachDbFilename=C:\Users\Rohit Rana\Desktop\Airline Reservation System VB.NET\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Connect Timeout=30;"
