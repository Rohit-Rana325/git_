...
Public Class signup
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "Match" Then
            Try
                Dim connection1 As New SqlConnection("Data Source=(localdb)\MSSQLLocalDB;AttachDbFilename=C:\Users\Rohit Rana\Desktop\Airline Reservation System VB.NET\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Connect Timeout=30;")
                connection1.Open()
            ...
            Catch ex As Exception
                MsgBox(" Failed to create Account!!", MsgBoxStyle.Critical)
            End Try
        Else
