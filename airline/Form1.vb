...
Public Class Form1
    ...
    Private Sub Button4_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If ComboBox1.Text = "USER" Then
            ...
            cnPodaci.ConnectionString = "Data Source=(localdb)\MSSQLLocalDB;AttachDbFilename=C:\Users\Rohit Rana\Desktop\Airline Reservation System VB.NET\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Connect Timeout=30;"
            cnPodaci.Open()
            ...
            If dr.HasRows Then
                ...
                MsgBox(" Succsessfully logged in.")
                TextBox10.Text = ""
                TextBox11.Text = ""
                Me.Hide()
            ...
            Else
                Beep()
                MessageBox.Show("Your username Or password does not match.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                TextBox10.Text = ""
                TextBox11.Text = ""
